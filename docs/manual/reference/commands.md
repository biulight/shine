...
This page reflects Shine 2.0.0-rc.2. Use `--help` on any subcommand for the exact interface of the
installed version.
...
The RC `shine --version` output is `shine 2.0.0-rc.2 (<commit> <date>)`; preview builds use the
SemVer-compatible label `2.0.0-rc.2.preview`.
