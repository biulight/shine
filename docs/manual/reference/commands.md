...
This page is reviewed through unreleased commit `e228922` on top of Shine 1.2.0. Use `--help` on any
subcommand for the exact interface of the installed version.
...
Stable `shine --version` output is `shine 1.2.0 (<commit> <date>)`; preview builds use a label such as
`1.2.0-preview`.
