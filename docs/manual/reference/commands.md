...
This page reflects Shine 1.5.0. Use `--help` on any subcommand for the exact interface of the
installed version.
...
Stable `shine --version` output is `shine 1.5.0 (<commit> <date>)`; preview builds use a label such as
`1.5.0-preview`.
