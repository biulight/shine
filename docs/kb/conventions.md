...
- The minimum supported Rust version is 1.86. The `mise.toml` toolchain may be newer for
  development, but changes to dependencies must keep the Rust 1.86 CI check passing.
