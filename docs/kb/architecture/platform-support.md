...
| App platform filtering | [`cli/src/apps/metadata.rs`](../../../cli/src/apps/metadata.rs) |
...
| Cross-platform split DNS | [`cli/src/sys/drivers/split_dns.rs`](../../../cli/src/sys/drivers/split_dns.rs) |
