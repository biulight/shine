...
| `core/src/runtime/shell_action_executor.rs` | Phase 4 Shell launcher create/update actions, per-platform resource and same-directory rollback journal, receipt-gated commit, and explicit fingerprint-guarded recovery |
