...
| `core/src/runtime/action_executor.rs` | Phase 4 App managed-file create journal, manifest-receipt-gated commit, explicit recovery Plan, and receipt-aware unchanged-content rollback |
