...
| `core/src/runtime/action_executor.rs` | Phase 4 App managed-file create/update/remove journal, manifest-receipt-gated commit, persistent backup restoration, same-directory rollback material, explicit recovery Plan, and unchanged-content remove/restore |
