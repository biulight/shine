...
| `core/src/runtime/action_executor.rs` | Phase 4 App managed-file create journal, receipt-gated commit, explicit recovery Plan, and unchanged-content rollback foundation |
