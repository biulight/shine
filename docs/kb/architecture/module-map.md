...
| `core/src/runtime/shell_action_executor.rs` | Phase 4 Shell launcher create/update/remove actions, per-platform resource and same-directory rollback journal, receipt/positive-removal-marker-gated commit, and explicit fingerprint-guarded recovery |
