...
restores that user file through a second fingerprint-bound rename. Each journal remains until its matching
...
Forced removal, JSON merge, generators, administrator writes, relocation, and other
