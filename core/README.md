...
target-local Preset permission declarations.
...
Plan. Permission declarations are statically validated but do not replace the existing external
code gates until later planner and enforcement slices land.
