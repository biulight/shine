...
target-scoped grants stored in the owner-only `~/.shine/trust.toml` file. Do not edit this file or
place grants in project configuration. Review and manage the current snapshot with:
